...
RESULTS_DIR = "results"   # must match the trainers
# ==============================================================================
...
from fx_mechanics import bdc_payoff_per_unit, trade_rate
from v0_game import closed_form_optimal_rate
from v2_multiple_rounds import (NO_FLOOR, _rate_at, bdc_baseline,
                                greedy_bdc_action, greedy_offer_action,
                                plot_game, solve_v2, terminal_wealth)

RESULTS = Path(__file__).resolve().parent / RESULTS_DIR
...
def main():
    ...
    from rl_train_ppo import run_dir, wrap_action
    ...
    report(spec, pol, out, label="PPO", curve=curve)
